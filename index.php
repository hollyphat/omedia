...
<head>
    ...
    <meta name="description" content="Web Devlopment company,  | +2348130327697. We also develop mobile applications(Android, iOS, BlackBerry, Windows Phone), engage in digital marketing, SEO, Cloud &amp; Regular hosting plus E-commerce setup.">
    <meta name="keywords" content="web design Nigeria, web design , website designer in , Online Medias, web designer in , web design company in , web designers in , website designer in , best web design company in nigeria, best web design , best web designers in , top web design firm, top design firms, Nigeria web designer, website design nigeria, e-commerce website, responsive, website development in Nigeria, web design company, Nigerian website designer company, web design companies in nigeria, website design companies in nigeria, website designers in  nigeria,  website design, web designer, website designer, web designers in nigeria, branding company in nigeria,  branding agency, responsive website designer, branding, design agency nigeria, , logo design nigeria, web site designers in Nigeria, web design firm, web site designer, web portal developer, website, web, e-commerce, graphic, business card, letterhead, logo, church website design, mosque website developer,mosque website designer Nigeria, 'online store developer in , Oyo, nigeria', school website designer, email marketing management , email marketing management nigeria, email marketing company, email marketing company , email marketing company nigeria, email marketing agency, email marketing agency , email marketing agency nigeria, seo Nigeria, seo , seo company, seo company , seo Nigeria, seo agency, seo agency , search engine optimization company, search engine optimization company , search engine optimization Nigeria, search engine optimization agency, search engine optimization agency , cooperate website design, cooperate website developer, Online Medias  company website designer">

    <meta property="og:title" content="Web Design &amp; Development, Cloud &amp; Regular Hosting, Mobile Applications Development(Android, iOS, BlackBerry, Windows Phone), E-commerce Setup, SEO | Online Medias | +2348130327697" />
    <meta property="og:title" content="Online Media"/>
    <meta property="og:image" content="http://onlinemedia.com.ng/img/logo.png"/>
    <meta property="og:url" content="http://onlinemedia.com.ng"/>
    <meta property="og:type" content="website"/>
    <meta property="og:site_name" content="Online Media"/>
    <meta property="author" content="Hollyfat" />
    <title>Online Media - Web | E-Commerce | Mobile</title>
    <script>
...
<!-- //counter -->
   <!--services-->
    ...
    <!-- testimonials -->
        ...
        <div class="container py-lg-5">
            <div class="text-center wthree-title pb-sm-5 pb-3">
                <h3 class="tittle-w3ls pb-4">Need a Project?</h3>
                <p class="tit mx-auto">Donec consequat sapien ut leo cursus rhoncus. Nullam dui mi, vulputate ac metus at, semper varm hic tenetur
                    a sapiente delectus reiciendis maiores aliius orci. Nulla accumsan ac elit in congue.</p>
            </div>
                        ...
                        <div class="register-top1">
                            <form action="#" method="get" class="register-wthree">
								...
								<div class="form-group">
                                    <div class="row">
										<div class="col-md-12">
                                            ...
                                            <input class="form-control" type="text" placeholder="Your Title" name="email" required="">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="row mt-lg-5 mt-3">
                                    ...
                                    <div class="col-md-12">
                                        <button type="submit" class="btn btn-agile btn-block w-100">Send Message</button>
                                    </div>
                                </div>
                            </form>
                        </div>
